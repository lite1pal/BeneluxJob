...
exports.userRouter.get("/:user_id", helpers_1.auth, userValidator_1.getUserValidator, helpers_1.handleValidationErrors, userController_1.getUser);
exports.userRouter.delete("/delete/:user_id", helpers_1.auth, userValidator_1.deleteUserValidator, helpers_1.handleValidationErrors, userController_1.deleteUser);
